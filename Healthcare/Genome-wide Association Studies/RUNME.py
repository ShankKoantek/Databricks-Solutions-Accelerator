...
# shashank
# It is very important to add the "docker_username" and "docker_password" in the secret scope
##############################################################################################
# docker_username = dbutils.secrets.get("solution-accelerator-cicd", "docker_username")
# docker_password = dbutils.secrets.get("solution-accelerator-cicd", "docker_password")

##### Docker secret scope #####
# databricks secrets create-scope --scope solution-accelerator-cicd
# databricks secrets put --scope solution-accelerator-cicd --key docker_username
# databricks secrets put --scope solution-accelerator-cicd --key docker_password
