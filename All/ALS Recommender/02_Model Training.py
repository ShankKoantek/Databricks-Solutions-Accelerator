...
ratings_train = get_percentage_of_data(ratings_train,0.001)
ratings_test = get_percentage_of_data(ratings_test,0.001)

ratings_sampled_train = get_percentage_of_data(ratings_sampled_train,0.001)
ratings_sampled_test = get_percentage_of_data(ratings_sampled_test,0.001)
...
ratings = ratings.sample(fraction=0.00001)
