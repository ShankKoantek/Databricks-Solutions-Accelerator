...
# Set the percentage of the data you want to keep
sample_frac = 0.1

# Sample a random subset of the data
sampled_df = training_df.sample(fraction=sample_frac, seed=42)

# Reassign the sampled dataframe to the original training dataframe variable
training_df = sampled_df

# Optionally, you can check the new size of the training data
...
import databricks.automl
from databricks.automl import ClassifyResult

# Define the target column name and primary metric to optimize for
target_col = 'label'
primary_metric = 'roc_auc'

# Specify the directory to store intermediate files generated by AutoML
data_dir = "/path/to/automl_data_dir"

# Define the classification model configuration
config = {
...
result: ClassifyResult = databricks.automl.classify(
    training_df,
...
# Print the AutoML summary and best model information
print(f"AutoML summary: {result.summary}")
