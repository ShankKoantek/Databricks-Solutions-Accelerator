...
goog_api_key = "AIzaSyBocgP0bwIDl5ia4074bWd3rWz37x02vEw"
address = "1600 Amphitheatre Parkway, Mountain View, CA"

# Define the Street View API URL
street_view_url = f"https://maps.googleapis.com/maps/api/streetview?size=640x640&fov=50&location={address}&key={goog_api_key}"

# Send a request to the API and get the image data
