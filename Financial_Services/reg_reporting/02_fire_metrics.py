...
# MAGIC %sql
# MAGIC CREATE SHARE regulatory_reports;
# MAGIC ALTER SHARE regulatory_reports ADD TABLE fire_pipeline.collateral;
...
# MAGIC 
# MAGIC <img src="https://databricks-web-files.s3.us-east-2.amazonaws.com/notebooks/reg_reporting/images/delta_share_activation.png" width=800>

# COMMAND ----------

# MAGIC %sql
# MAGIC CREATE RECIPIENT regulatory_body;
